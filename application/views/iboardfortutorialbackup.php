                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php
                          if($admin){
                            ...
                            echo "<li  class='desktop'>
                                <div class='row' style='margin-left:20px;'><div class='four columns'></div>
                                <div class='eight columns'><h3 id='numero7' class='someclass'></h3></div></div><a href='http://efast.eidwhd.com/index.php/main/chartlevel'>
                        ...
                        <?php
                          if($admin!="1"){
                            echo "<li  class='desktop'>
                                <div class='row' style='margin-left:20px;'><div class='four columns'></div>
                                <div class='eight columns'><h3 id='numero7' class='someclass'></h3></div></div><a href='http://efast.eidwhd.com/index.php/main/contactekunbar'>
                                <i class='fa fa-ticket'></i><span style='margin-right:10px'>E Fast </span><small class='label label-danger'>IT Support</small>
                                <i class='#'></i></a>
                        </li>";
                          }
