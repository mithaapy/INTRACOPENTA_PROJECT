			...
			<div class="wrapper style2">
				...
				<article id="main" class="container special" style="width:100%">
					...
					<footer>
						...
						<button class='btn btn-default btn-sm detailzoom' style="font-size:20px;padding:0 20px" ><a href="http://warehouse.eidwhd.com/index.php/dash/editcontactnya" class="button">Update Information</a>
						</button>
	        			...
	        			<div class="modal-dialog" style="padding:0 15%">
            				...
            				<div class="modal-body">
              				<div id="container">
               				...
               				<p style="font-size:14px; color:white;">Change name of your photo same as your login first (no space). example : ekunbar.jpg<br/>File Type : .jpg | Recomended Size : 200x263px <br/> Notes: If your profile Picture not Updated, Log-out and Log-in Again.</p>
                 			<div class="row">
		              	<div class="col-md-8">
...
<!-- PopUp -->
				    <!-- Pop Up 3-->
          <div style="display:none;margin-top:1em;padding:0 4em 0 4em;background:#df7366;" class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="padding:0 15%">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>          
                  <h5 class="modal-title" id="myModalLabel" style="padding-top:50px;font-size:30px">CHANGE PASSWORD</h5> 
                  </div><br/>
                  <div class="modal-body">
                    <div id="container">
                      <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div style="width:75%"><input type="password" class="form-control" id="old" name="old" required></div>
                      </div><br>                
                      <div class="row">
                        <div class="col-md-3"><h7>New Password</h7></div>
                        <div style="width:75%"><input type="password" class="form-control" id="new" name="new" required></div>
                      </div>
                      </div><br/><br/>
                      <input type="submit" value="Upload" class="btn btn-primary"/> 
                      </form><br/><br/><br/>              
