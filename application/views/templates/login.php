...
<body>
    ...
    <div class="row" style="margin-right: 0px !important; margin-left: 0px !important;">
        ...
        <div class="col-md-10 ekunbargerak" style="text-align:center"><div class="desktop"><br/><br/><br/></div>
            <h2 style="color:#444;font-family:sans-serif">INTA<span style="font-size:20px;color:#AAA"> Cross Selling</span></h2><br/></div></div>
</div>
...
<div class="row ekun-login-formnya" style="margin-right: 0px !important; margin-left: 0px !important;">
    ...
    <div class="col-md-4">
        <form class="wellekunbar" method="POST" action="<?php echo base_url(); ?>index.php/frontpage/login"><br/><br/>
            <div class="form-group">
                <p/>WELCOME. PLEASE LOGIN.</p></div>
...
<div class='ekunbarfooter' style="font-size: 10px; position: fixed; bottom: 0; margin-bottom:0px; left: 50%; margin-left: -200px; color:#555; width: 400px; height: 30px;">
    <p align="center"><strong>Copyright © 2015 <a href="#">INTA</a>.</strong></p>
</div>