...
<h3 style="font-family: EricssonCapital;color:#444"><span>EIDWHD TOOLS |</span><span class="kecilin-span-sepuluh" style="font-size:12px;">EIDWHD.COM</span></h3><div class="desktop"><br/><p style="font-family: EricssonCapital;color:#444"/>THINK SMART, WORK SMART.</p></div></div>
</div>

<div class="row ekun-login-formnya" style="margin-right: 0px !important; margin-left: 0px !important;">

   <div class="col-md-1"></div>
   <div class="col-md-6 desktop"><br/><br/><p style="font-family: EricssonCapital;color:#fff;font-size:12px"/>Networked Society.</p>
...
<div class='ekunbarvideo2' style='width:560px;height:315px'>
