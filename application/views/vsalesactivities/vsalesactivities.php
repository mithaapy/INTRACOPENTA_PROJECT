                    ...
                    <table class='table table-bordered table-striped table-condensed datatables'>
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Suspect ID</th>
								...
								<th style="text-align: center; vertical-align: middle;">Visit Purpose</th>
                                <th style="text-align: center; vertical-align: middle; width: 90px">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($salesactivities as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->suspects_id ?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->prospects_id ?></td>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->visitpurposes_name  ?></td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <a class='btn btn-default btn-sm' href='javascript:;' onclick="action_form('edit', '<?php echo $row->salesactivities_id ?>')" title="Edit"><i class='fa fa-edit'></i></a>
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/consalesactivities/delete/<?php echo $row->salesactivities_id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').fadeOut();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/consalesactivities/get_form',
            type: 'POST',
