...
<form enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() . 'index.php/conusers/' . $function; ?>" method="POST">
    <div class="form-group col-sm-12">
        <div class="col-sm-2"><label>ID User</label></div>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="id" name="id" placeholder="ID User" value="<?php echo $data->users_id; ?>" readonly>
        </div>
    </div>
    <div class="form-group col-sm-12">
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-10">
            <select class="form-control" id="idrole" name="idrole" required="true">
                <option value="<?php echo $data->users_idrole ?>" selected><?php echo $data->roles_name ?></option>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <img alt="User Photo" class="img-responsive box" src="<?php echo base_url() . $data->users_picture; ?>" style="border-style: solid; border-color: #333333"/>
        </div>
