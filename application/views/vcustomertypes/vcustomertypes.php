        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class='table-responsive' id='divgridview'>
                    ...
                    <a class='btn btn-default' href='<?php echo base_url() ?>assets/files/export/default/template_customertypes.xls'><i class='fa fa-download'></i> Download Template</a>
                    <hr/>
                    <table class='table table-bordered table-striped table-condensed datatables'>
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Level 1</th>
                                <th style="text-align: center; vertical-align: middle;">Level 2</th>
                                <th style="text-align: center; vertical-align: middle;">Level 3</th>
                        ...
                        <tbody>
                            <?php foreach ($customertypes as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->level1 ?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->level2 ?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->level3 ?></td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        ...
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/concustomertypes/delete/<?php echo $row->id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').slideUp();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/concustomertypes/get_form',
            type: 'POST',
