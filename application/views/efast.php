                        ...
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">EFAST Support Ticket</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://efast.eidwhd.com/index.php/main/insertefast">
                                        <div class="form-group">Signum/Name :
                                            <input type="text" class="form-control" name="signum" id="signum" placeholder="Signum/Name" value="<?php echo $user; ?>" readonly/><input type="hidden" class="form-control" name="from" id="from" value="<?php echo $from; ?>" readonly/>
                                        </div>
                                        <div class="form-group">Your Email
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email@hostname.com"  value="<?php echo $emailnya; ?>"/>
                                        </div><br/><hr/>
                                        <div class="form-group">Ticket Type
                                            <select id="comgroup" name="comgroup"  class="form-control" style="cursor:pointer;">
                                        	<option value="Data Issue">Data Issue</option>
                                                <option value="Login Access">Login Access</option>
					        <option value="Maintenance Application">Maintenance Application</option>
                                                <option value="ew Application">New Application</option>
                                                <option value="IT Problem">IT Problem</option>
					        <option value="Others">Others</option>
                                            </select>
                                        </div>
                                        <div class="form-group">Ticket Title
                                            <input type="text" class="form-control" name="comtitle" id="comtitle" placeholder="Title of Ticket"/>
                                        </div>
                                        <div>
                                        ...
                                        <div class="form-group">Problem Contact
                                            <input type="text" class="form-control" name="pic" id="pic" value="Ekunbar - Kuncoro Wicaksono" readonly/>
                                        </div>
                                    
                                </div>
                                <div class="box-footer clearfix">
<!--<input type="submit" value="Submit" class="input-control btn-blue" style="cursor:pointer;">-->
                                    <button type="submit" class="pull-right btn btn-info" id="sendEmail">Send <i class="fa fa-arrow-circle-right"></i></button>
                                </div>
                            </div></form>
</section>
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <ul class="todo-list">
                                    <li><span align='justify'><b>Have any idea ? Or maybe ..<br/>You have any Problem ?</b><br/><br/>Please feel free for using this efast ticketing support's app if you have specific requirements or even if you have a problem occured eidwhd.com. And You're posible to catch your support ticket in here too.  </span></a></li>                                       
                                </ul>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        <!--second-->
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Your Ticket</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <ul class="todo-list">
                                <?php
                                    ...
                                    echo "<i class='fa fa-clock-o'></i> ".$key['com_date']."</small></li>";
                                }
                                ?>                                         
                                </ul>
                                </div><!-- /.box-body -->
