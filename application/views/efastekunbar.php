                        ...
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box box-danger">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">EFAST | <small><?php echo $getefastdetail[0]['comp_refference']; ?></small></h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://efast.eidwhd.com/index.php/main/insertefast">
                                       
                                        <ul class="todo-list ui-sortable"><li><div class="form-group"><h4>Ticket Title <br/><?php echo $getefastdetail[0]['comtitle']; ?></h4>
                                        </div><br/></li>
                                        <li><div class="form-group"><h4>Ticket Detail</h4><br/>
                                            <?php echo $getefastdetail[0]['issue']; ?>
                                        </div></li><li>
                                        <div class="form-group">Ticket By : 
                                            <?php echo $getefastdetail[0]['user']; ?> / <?php echo $getefastdetail[0]['email']; ?>
                                        </div></li></ul>
...
<!-- seccond -->
                            ...
                            <div class="box box-danger">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">List of Another Complaint</h3>
                                    <div class="pull-right box-tools">
                                        <button class="btn btn-danger btn-sm" data-widget='collapse' data-toggle="tooltip" title="Collapse">Open</button>
                                    </div><!-- /. tools -->
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <ul class="todo-list">
                                <?php
                                    foreach($efastlist AS $key){
                                    echo "<li><span class='handle'><i class='fa fa-ellipsis-v'></i> <i class='fa fa-ellipsis-v'></i></span>";  
                                    echo "<a href='efastdetail/".$key['comp_refference']."'><span class='text'>".$key['comp_refference']."</span></a>";
                                    echo "<small class='label label-danger' style='float:right'>";
                                    echo "<i class='fa fa-clock-o'></i> ".$key['com_date']."</small><br/>";
                                    echo "<div style='padding-left:25px'>".$key['issue']."<br/><small><b>Complainer: ".$key['user']."</b></small></div></li>";
                                }
                                ?>                                         
                                </ul>
                                </div><!-- /.box-body -->
                                <div class="box-footer clearfix no-border">
                                  <div class="row">
                                    <div class="col-xs-3 col-sm-3 col-md-3" align="center"><small ><i class="label label-danger fa fa-clock-o"> </i> Open </small></div>
                                    <div class="col-xs-3 col-sm-3 col-md-3" align="center"><small ><i class="label label-info fa fa-clock-o"> </i> Confirmation </small></div>
                                    <div class="col-xs-3 col-sm-3 col-md-3" align="center"><small ><i class="label label-warning fa fa-clock-o"> </i> On Progress </small></div>
                                    <div class="col-xs-3 col-sm-3 col-md-3" align="center"><small ><i class="label label-success fa fa-clock-o"> </i> Closed </small></div>
                                  </div>
                                </div>
                            </div><!-- /.box -->
                        ...
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box box-danger">
                                <div class="box-header">
                                    <i class="fa fa-envelope"></i>
                                    <h3 class="box-title">EFAST | Admin</h3>
                                    <!-- tools box -->
                                    <div class="pull-right box-tools">
                                        <button class="btn btn-danger btn-sm" data-widget='collapse' data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /. tools -->
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://efast.eidwhd.com/index.php/main/insertefast">
                                        <div class="form-group">Signum/Name :
                                            <input type="text" class="form-control" name="signum" id="signum" placeholder="Signum/Name" value="<?php echo $user; ?>" readonly/><input type="hidden" class="form-control" name="from" id="from" value="<?php echo $getefastdetail[0]['user']; ?>" readonly/>
                                        </div>
                                        <div class="form-group">Email
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email@hostname.com"  value="<?php echo $getefastdetail[0]['email']; ?>"/>
                                        </div>
                                        <div class="form-group">Ticket Type
                                            <input type="text" class="form-control" name="comgroup" id="comgroup" placeholder="Email@hostname.com"  value="<?php echo $getefastdetail[0]['email']; ?>"/>
                                        </div><br/>
                                        <div class="form-group">Ticket Title
                                            <input type="text" class="form-control" name="comtitle" id="comtitle" placeholder="Title of Ticket"  value="<?php echo $getefastdetail[0]['comtitle']; ?>"/>
                                        </div>
                                        <div>Ticket Detail :<br/>
                                            <?php echo $getefastdetail[0]['issue']; ?>
                                        </div><br/><hr/>
                                        <div>
                                            <textarea name="comp" id="comp" class="textarea" placeholder="Message" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                        </div>
                                    
                                </div>
                                <div class="box-footer clearfix">
<!--<input type="submit" value="Submit" class="input-control btn-blue" style="cursor:pointer;">-->
                                    <button type="submit" class="pull-right btn btn-info" id="sendEmail">Notif <i class="fa fa-arrow-circle-right"></i></button>
                                </div>
                            </div></form>
</section>
                   </div>
