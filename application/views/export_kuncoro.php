<?php
    ...
    $objWriter->save("assets/kuncorodownloaded/inta".$quotation[0]['PROSPECTID'].".xlsx");
    ...
    echo "<script>window.location='../../../assets/kuncorodownloaded/inta".$quotation[0]['PROSPECTID'].".xlsx';</script>";
?>
