        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class='table-responsive' id='divgridview'>
                    ...
                    <a class='btn btn-default' href='<?php echo base_url() ?>assets/files/export/default/template_productpromotions.xls'><i class='fa fa-download'></i> Download Template</a>
                    <hr/>
                    <table class='table table-bordered table-striped table-condensed datatables'>
                        ...
                        <tbody>
                            <?php foreach ($productpromotions as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->productpromotions_name?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->productpromotions_description ?></td>  
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->productpromotions_validdatestart.' / '.$row->productpromotions_validdateend ?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->productpromotions_active ?></td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <a class='btn btn-primary btn-sm' href='javascript:;' onclick="action_form('detail', '<?php echo $row->productpromotions_id ?>')" title="Detail"><i class='fa fa-search'></i></a>
                                        <a class='btn btn-default btn-sm' href='javascript:;' onclick="action_form('edit', '<?php echo $row->productpromotions_id ?>')" title="Edit"><i class='fa fa-edit'></i></a>
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/conproductpromotions/delete/<?php echo $row->productpromotions_id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').slideUp();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/conproductpromotions/get_form',
            type: 'POST',
