                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        <?php echo $name; ?>
                                        <small><?php echo $companyname; ?> <br/> <?php echo $from; ?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>">
                                <i class="fa fa-arrow-circle-o-right"></i> <span>Leads Registration</span>
                            </a>
                        </li>                      
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href='http://localhost/intacom/index.php/frontpage/pslead'><i class='fa fa-angle-double-right'></i>Lead</a></li>
                                <li><a href='http://localhost/intacom/index.php/frontpage/pssuspect'><i class='fa fa-angle-double-right'></i>Suspect</a></li>
                                <li><a href='http://localhost/intacom/index.php/frontpage/psprospect'><i class='fa fa-angle-double-right'></i>Prospect</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>">
                                <i class="fa fa-arrow-circle-o-right"></i> <span>Setting</span>
                            </a>
                        </li>  
                        <!--<li>
