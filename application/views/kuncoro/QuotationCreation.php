            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb ekunfontslide">
                        ...
                        <li class="active">Quotation Creation </li>
                    </ol>
                </section>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$key['APPROVDATE']."</td>
                                                    <td class='' style=''>
                                                        <a class='btn btn-sm btn-warning' target='_blank' href='".base_url()."index.php/frontpage/exportPDF/".$key['PROSPECTID']."' _blank>
                                                            <i class='glyphicon glyphicon-print'></i>&nbsp;<span class='desktop'>Download</span>
                                                        </a>&nbsp;&nbsp;<a class='btn btn-sm btn-primary' href='".base_url()."index.php/frontpage/editquotation/".$key['PROSPECTID']."' _blank>
                                                            <i class='glyphicon glyphicon-share-alt'></i>&nbsp;<span class='desktop'>Edit</span>
                                                        </a></td>
                                            </tr>";
                                            } 
                                            ?>
