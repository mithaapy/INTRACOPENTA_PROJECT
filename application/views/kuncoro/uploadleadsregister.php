            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb ekunfontslide">
                        ...
                        <li class="active">Uplaod Leads Registration </li>
                    </ol>
                </section>
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Upload Registration Form</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-2">                                
                            <?php echo form_open_multipart('frontpage/uploadleadsregisterengine');?>
                            <label for="input-project-name" class="col-sm-12 control-label">Upload</label>
                        </div>
                        <div class="col-md-6">                                        
                                <input type="file" class="form-control" id="upload" name="file">
                        </div>
                        <div class="col-md-2">
                                <button class="btn btn-info" type="submit" id="uploadBtn2" class="btn btn-danger"><i class="glyphicon glyphicon-upload"></i> Upload Leads</button>
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-2"> 
                            <label for="input-project-name" class="col-sm-12 control-label">Download :</label>
                        </div>
                        <div class="col-md-6">                                        
                            <label for="input-project-name" class="col-sm-12 control-label"><a href="<?php echo base_url()."assets/kuncorotemplate/templateimport.xls";?>">Template Upload</a></label>
                        </div><br/><br/><br/>
                        </div>
                    </div>
                </div><!-- /.box-body -->
