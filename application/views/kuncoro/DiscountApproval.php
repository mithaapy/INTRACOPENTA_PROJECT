                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td class='' style=''>
                                                        <a class='btn btn-sm btn-primary' href='".base_url()."index.php/frontpage/editDiscount/".$key['PROSPECTID']."' _blank>
                                                            <i class='glyphicon glyphicon-share-alt'></i>&nbsp;<span class='desktop'>Discount Approval</span>
                                                        </a></td>
                                            </tr>";
                                            } 
                                            ?>
