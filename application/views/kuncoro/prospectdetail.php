            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb ekunfontslide">
                        ...
                        <li>Prospect Registration </li>
                        <li class="active">Prospect Detail </li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>                                            
                                            <?php 
                                                ...
                                                echo "<tr>
                                                    <td>".$key['PROSPECT_DETAIL_ID']."</td>
                                                    <td>".$key['PROSPECTID']."</td>
                                                    <td>".$key['PRODUCTID']."</td>
                                                    <td>".$key['PRODUCTNAME']."</td>
                                                    <td class='' style=''>
                                                        <a class='btn btn-sm btn-primary' style='width:98%' href='../prospectdetailregister/".$key['PROSPECTID']."/".$key['PROSPECT_DETAIL_ID']."'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <a href="../psprospect" class="btn btn-default" style="width:100%"><i class="fa fa-arrow-circle-left"></i> Back</a><br/><br/>
                                        </div>
                                        <div class="col-md-8">
                                        </div>
                                        <div class="col-md-2">
                                            <a href="../prospectdetailregister/<?php echo $leadDetail[0]['PROSPECTID'];?>/0" style="width:100%" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add</a><br/><br/>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
