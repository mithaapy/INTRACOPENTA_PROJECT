            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb ekunfontslide">
                        ...
                        <li>Leads Registration </li>
                        <li class="active">Leads Detail </li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="../leadsdetailregister/<?php echo $leadid;?>/0" class="btn btn-primary pull-right" style="width:100%"><i class="fa fa-plus"></i> Add</a><br/><br/>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
