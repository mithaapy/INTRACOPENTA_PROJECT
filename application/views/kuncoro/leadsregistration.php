                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                                foreach($lead AS $key){
                                                echo "<tr>
                                                    <td style='text-align:right'>".$key['LEADSID']."</td>
                                                 ...
                                                 echo "</td>
                                                    ...
                                                    <td class='' style=''>
                                                        <a class='btn btn-sm btn-primary' style='width:46%' href='leadsregister/".$key['LEADSID']."'>
                                                            <i class='fa fa-eye'></i>&nbsp;<span class='desktop'>View</span>
                                                        </a>&nbsp;&nbsp;
                                                        <a class='btn btn-sm btn-default' style='width:46%' href='leadsdetail/".$key['LEADSID']."'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <a href="uploadleadsregister/0" class="btn btn-warning pull-right" style="width:100%"><i class="glyphicon glyphicon-upload"></i> Bulk Import</a><br/><br/>
                                        </div>
                                        <div class="col-md-8">
                                        </div>
                                        <div class="col-md-2">
                                            <a href="leadsregister/0" class="btn btn-primary pull-right" style="width:100%"><i class="fa fa-plus"></i> Add</a><br/><br/>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
