                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td class='' style=''>
                                                        <a class='btn btn-sm btn-primary' style='width:46%' href='prospectregister/".$key['PROSPECTID']."'>
                                                            <i class='fa fa-eye'></i>&nbsp;<span class='desktop'>View</span>
                                                        </a>&nbsp;&nbsp;
                                                        <a class='btn btn-sm btn-default' style='width:46%' href='prospectdetail/".$key['PROSPECTID']."'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="prospectregister/0" class="btn btn-primary pull-right" style="width:100%"><i class="fa fa-plus"></i> Add</a><br/><br/>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
