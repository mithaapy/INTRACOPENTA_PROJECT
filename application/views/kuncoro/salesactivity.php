		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview active">
					...
					<ul class="treeview-menu">
						<li>
							<a href="<?php echo base_url();?>index.php/frontpage/salestarget"><i class="fa fa-angle-double-right"></i>Sales Target</a>
						</li>
						<li class="active">
							<a href="<?php echo base_url();?>index.php/frontpage/salesactivity"><i class="fa fa-angle-double-right"></i>Sales Activity</a>
						</li>
						<li>
