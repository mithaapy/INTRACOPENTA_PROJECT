                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red" style="background-color: #CE0000 !important;">
                                ...
                                <a href="<?php echo ('http://idist.eidwhd.com/index.php/main/detailweekdata?due_date='.date('Y').'-W'.$idist[0]['WEEKNYA'].'&dsp=SCH&kpi=ericsson') ?>" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
<div class="col-lg-3 col-xs-6">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-orange" style="background-color: #F60 !important;">
                                ...
                                <a href="<?php echo base_url('idist/index.php/main/detailweekdata?due_date='.date('Y').'-W'.$idist[0]['WEEKNYA'].'&dsp=TNT&kpi=ericsson') ?>" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-3 connectedSortable">
                            ...
                            <div class="box box-danger">
                                ...
                                </div><!-- /.box-body --><span style='
  float: right;
  margin-top: -15px;'><a href='loginlog'>More</a></span>
                            </div><!-- /.box -->
                         </section>
