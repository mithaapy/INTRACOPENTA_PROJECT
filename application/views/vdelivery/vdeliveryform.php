...
<form enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() . 'index.php/conorderonhand/' . $function; ?>" method="POST" >
	...
	<div class="form-group col-sm-12">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="confirmdate" name="confirmdate" placeholder="Please click to choose confirm date" value="<?php echo $data->prospectalls_confirmdate ?>" readonly>
        </div>
    </div>
	<div class="form-group col-sm-12">
        <div class="col-sm-2"><label>Delivery Date / By</label></div>
        <div class="col-sm-5">
            <input type="text" class="form-control" id="deliverydate" name="deliverydate" placeholder="Delivery Date" value="<?php echo $data->prospectalls_deliverydate ?>" required="true">
        </div>
		<div class="col-sm-5">
	...
	<div class="form-group col-sm-12">
        <div class="col-sm-2"><label>Delivery No / Bast No</label></div>
        <div class="col-sm-5">
            <input type="text" class="form-control" id="deliveryno" name="deliveryno" placeholder="Delivery Date" value="<?php echo $data->prospectalls_deliveryno ?>" required="true">
        </div>
		<div class="col-sm-5">
	...
	<div class="form-group col-sm-12">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="incentiveno" name="incentiveno" placeholder="Incentive No" value="<?php echo $data->prospectalls_incentiveno ?>" readonly>
        </div>
    </div>
