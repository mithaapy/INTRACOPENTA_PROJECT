                    ...
                    <table class='table table-bordered table-striped table-condensed datatables'>
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Year Plan Value / Qty</th>
                                <th style="text-align: center; vertical-align: middle;">Year Act Value / Qty</th>
                                <th style="text-align: center; vertical-align: middle;">Month Plan Value / Qty</th>
                                <th style="text-align: center; vertical-align: middle;">Month Act Value / Qty</th>
                                <th style="text-align: center; vertical-align: middle; width: 90px">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($salestargets as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->salestargets_targetyear?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->salestargets_yearplanvalue.' / '.$row->salestargets_yearplanqty?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->salestargets_yearactvalue.' / '.$row->salestargets_yearactqty?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->salestargets_monthplanvalue.' / '.$row->salestargets_monthplanqty?></td>
                                    <td style="text-align: left; vertical-align: middle;"><?php echo $row->salestargets_monthactvalue.' / '.$row->salestargets_monthactqty?></td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <a class='btn btn-default btn-sm' href='javascript:;' onclick="action_form('edit', '<?php echo $row->salestargets_id ?>')" title="Edit"><i class='fa fa-edit'></i></a>
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/consalestargets/delete/<?php echo $row->salestargets_id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').fadeOut();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/consalestargets/get_form',
            type: 'POST',
