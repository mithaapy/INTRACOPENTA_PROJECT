                    ...
                    <table class='table table-bordered table-striped table-condensed datatables'>
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Customer PO No</th>
                        ...
                        <tbody>
                            <?php foreach ($prospectalls as $row): ?>
                                <tr>
									...
									<td style="text-align: left; vertical-align: middle;"><?php echo $row->prospectalls_customerpono ?></td>
									<td style="text-align: left; vertical-align: middle;"><?php echo $row->prospectalls_podate ?></td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        ...
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/conorderonhand/delete/<?php echo $row->prospectalls_id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').fadeOut();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/conorderonhand/get_form',
            type: 'POST',
