...
<form enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() . 'index.php/conorderonhand/' . $function; ?>" method="POST" >
	...
	<div class="form-group col-sm-12">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" id="dpdate" name="dpdate" placeholder="Please click to choose DP Date" value="<?php echo $data->prospectalls_dpdate ?>"required="true">
        </div>
		<div class="col-sm-5">
            <input type="text" class="form-control" id="dpvalue" name="dpvalue" placeholder="DP Value" value="<?php echo $data->prospectalls_dpvalue ?>"required="true">
        </div>
    </div>
	 <div class="form-group col-sm-12">
        <div class="col-sm-2"><label>Bank Cash / Name</label></div>
        <div class="col-sm-5">
            <input type="text" class="form-control" id="bankcash" name="bankcash" placeholder="Bank Cash" value="<?php echo $data->prospectalls_bankcash ?>"required="true">
        </div>
		<div class="col-sm-5">
            <input type="text" class="form-control" id="bankname" name="bankname" placeholder="Bank Name" value="<?php echo $data->prospectalls_bankname ?>"required="true">
        </div>
    </div>
	<hr/>
	<h3 class='ekunfontslide'>
	...
	<div class="form-group col-sm-12">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" id="leasename" name="leasename" placeholder="Lease Name" value="<?php echo $data->prospectalls_leasename ?>"required="true">
        </div>
		<div class="col-sm-5">
            <input type="text" class="form-control" id="leasepono" name="leasepono" placeholder="Lease PO No" value="<?php echo $data->prospectalls_leasepono ?>"required="true">
        </div>
    </div>
	<div class="form-group col-sm-12">
        <div class="col-sm-2"><label>Lease Value</label></div>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="leasevalue" name="leasevalue" placeholder="Lease Value" value="<?php echo $data->prospectalls_leasevalue ?>"required="true">
        </div>
    </div>
