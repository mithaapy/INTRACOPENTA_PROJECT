                            ...
                            <?php foreach ($companies as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        ...
                                        <a class='btn btn-warning btn-sm' href='<?php echo base_url() ?>index.php/concompanies/delete/<?php echo $row->id ?>' title="Delete" onclick="return confirm('Are you sure want to delete this data?')"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').slideUp();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/concompanies/get_form',
            type: 'POST',
