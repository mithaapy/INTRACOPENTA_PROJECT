                            ...
                            <?php foreach ($quotations as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
										<a class='btn btn-warning btn-sm' href='javascript:;' onclick="action_form('edit', '<?php echo $row->quotations_id ?>')" title="Discount"><i class='fa fa-tags'></i></a>
...
<script type="text/javascript">
    function action_form(type, id) {
        $('.alert-notif').slideUp();
        $.ajax({
            url: '<?php echo base_url() ?>index.php/condiscounts/get_form',
            type: 'POST',
