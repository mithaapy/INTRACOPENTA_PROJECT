...
<form enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() . 'index.php/conquotations/' . $function; ?>" method="POST" >
    ...
    <hr/>
    <br/>
    <h3 class='ekunfontslide'>Quotation Notes &nbsp;&nbsp;
	<button style="<?php echo $styleaddqn ?>" type="button" id="addquotationnotes" name="addquotationnotes" class="btn btn-default"><i class="fa fa-list"></i> Add Quotation Notes</button>
	</h3>
     <?php
    $valrows = 1;
    if ($function == "edit"):
    ...
    <h3 class='ekunfontslide'>
        Accessories &nbsp;&nbsp;
        <button style="<?php echo $styleaddpa ?>" type="button" id="addaccessories" name="addaccessories" class="btn btn-default"><i class="fa fa-list"></i> Add Accessories</button>
    </h3>
    <?php
    $valrows = 1;
    if ($function == "edit"):
    ...
    <div class='table-responsive'>
        ...
        <table class='table table-bordered table-striped table-condensed datatablesdetails'>
            ...
            <tbody>
                ...
                for ($i = 1; $i <= 10; $i++):
                    if ($function == 'edit'):
                        if (count($data_prospectaccessories) >= $i):
                            $stylerows = '';
                        else :
                            $stylerows = 'display:none;';
                        endif;
                    ...
                    ?>
                    <tr id="rowaccessories<?php echo $i ?>" style="<?php echo $stylerows ?>">
                        <td style="text-align: left; vertical-align: middle;">
                            <input type="hidden" id="id<?php echo $i ?>" name="id<?php echo $i ?>" value="<?php echo $data_prospectaccessories[$i - 1]->prospectaccessories_id ?>">
                            <select class="form-control" id="idaccessories<?php echo $i ?>" name="idaccessories<?php echo $i ?>">
    ...
    <?php endforeach; ?>
                        ...
                        <td style="text-align: left; vertical-align: middle; <?php echo $styleactionpa ?>;">
                            <select class="form-control" id="action<?php echo $i ?>" name="action<?php echo $i ?>">
                                <option value="" selected></option>
                                <option value="delete">Delete</option>
                            </select>
