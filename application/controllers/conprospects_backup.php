...
class Conprospects extends CI_Controller {
    ...
    public function edit() {
		...
		if (($post['customerpono'] == null) && ($post['podate'] == null)):
			$data_save1 = array(
				'id' => $post['id'],
		...
		//elseif (!empty($post['customerpono'])):
			$data_save2 = array(
                'id' => $post['id'],
                'idstage' => '4'
            );
            ...
            $query5 = $this->model_prospectalls->insert($data_save5);
			 ...
			 /*if ($post['idstatus'] == '19') :
                ...
                $query4 = $this->model_prospectalls->insert($data_save4);
			 endif;
			 ...
			 if ($post['idstatus'] == '20') :
                ...
                $query4 = $this->model_competitions->insert($data_save4);
			 endif;
			 */
