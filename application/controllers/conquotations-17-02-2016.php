...
<html >
  ...
  <body>
      ...
      <table class="wrap" style="width:650px; margin:0px auto;">
          ...
          <tr> 
           <td>
              To:
              <br />'.
              $gender.$data_quotations[0]->customers_name.'<br />
              Attn : '.$data_customercp[0]->customercp_firstname . ' ' . $data_customercp[0]->customercp_lastname.'<br />
      ...
      <div class="table-header" style="width:650px; background-color:#aaa; border-left:1px solid #333; border-right:1px solid #333; border-top:1px solid #333; overflow:hidden; margin:auto;">
          <div class="left-col" style="float:left; width:330px; text-align:center; padding:0px 0 0px 0;">
              '.$data_quotations[0]->products_name.'
          </div>
          <div class="right-col" style="float:right; width:300px; text-align:center; padding:0px 0 0px 0;">
              Price
          </div>
      </div>
      <table style="width:650px; margin:0px auto; border:1px solid #333;" cellspacing="0" cellpadding="0">
          ...
          <tr>
              <td style="border-bottom:1px solid #333; font-size:11px; border-right:1px solid #333;">'.$i.'</td>
              ...
              <td style="border-bottom:1px solid #333; font-size:11px; border-right:1px solid #333; padding:0 10px 0 10px;">'.number_format($data_productprices[0]->productprices_listprice, 2, '.', ',').' / Un</td>
              <td style="border-bottom:1px solid #333; font-size:11px;">'.number_format($data_productprices[0]->productprices_netprice, 2, '.', ',').'</td>
          </tr>';
         /*
          * Accessories
          */
       ...
       if(!empty($data_prospectaccessories[0]->accessories_name)):
           ...
           $html.=' <tr>
              ...
              <td style="border-bottom:1px solid #333; font-size:11px; border-right:1px solid #333; padding:0 10px 0 10px;">'.number_format($data_prospectaccessori->accessories_price, 2, '.', ',').'</td>
              <td style="border-bottom:1px solid #333; font-size:11px; border-right:1px solid #333; padding:0 10px 0 10px;">'.number_format($data_prospectaccessori->accessories_price, 2, '.', ',').'</td>
          </tr>';
        ...
        $total_price=$pdt_net_price+$acc_total_price;
         $html.=' <tr>
              <td></td>
              <td></td>
              <td style="border-bottom:1px solid #333; border-right:1px solid #333; font-size:11px; padding:0 10px 0 10px;"></td>
              <td style="border-bottom:1px solid #333; border-right:1px solid #333; font-size:11px; padding:0 10px 0 10px;">Total</td>
              <td style="border-bottom:1px solid #333; border-right:1px solid #333; font-size:11px; padding:0 10px 0 10px;">'.number_format($total_price, 2, '.', ',').'</td>
          </tr>
          </table>';
         /*
          * Quotations
      ...
      <table style="width:650px; margin:0px auto;">';
         ...
         $html.='  <tr>
              ...
              <td style="font-size:11px;">'.$qtext['description'].'</td>
          </tr>';
            endforeach;
            $html.='</table>';
                endforeach;
